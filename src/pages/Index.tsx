...
const MENU_ITEMS = [
  ...
  { id: 2, name: "Шашлык из свинины", weight: "350г", price: 450, tag: "", emoji: "🐷", desc: "Шейная часть, лук, пиво, чёрный перец" },
  ...
  { id: 5, name: "Рибай на углях", weight: "350г", price: 890, tag: "Премиум", emoji: "🥩", desc: "Мраморная говядина, розмарин, трюфельное масло" },
  { id: 6, name: "Тарелка овощей", weight: "400г", price: 290, tag: "", emoji: "🫑", desc: "Сезонные овощи, оливковое масло, прованские травы" },
];
